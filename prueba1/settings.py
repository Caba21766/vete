...
DEBUG = False
# -------------------------------------------------------------------------------------
ALLOWED_HOSTS = ['reydelpollo.com.ar', 'www.reydelpollo.com.ar']
# -------------------------------------------------------------------------------------
...
DATABASES = {
    'default': {
        ...
        'HOST': 'dbaas-db-4486644-do-user-24058056-0.e.db.ondigitalocean.com',
        'PORT': '25060',
        'OPTIONS': {
            'ssl_ca': '/root/vete/ca-certificate.crt',
        },
    }
}
...
MERCADOPAGO_ACCESS_TOKEN = "APP_USR-5843903127319245-041816-3002d23aa9db17a72ddf9789708f5065-162573563"
# -------------------------------------------------------------------------------------
